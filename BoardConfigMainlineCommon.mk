...
BAK_BOARD_VENDOR_SEPOLICY_DIRS := $(BOARD_VENDOR_SEPOLICY_DIRS)
-include glodroid/configuration/common/modem/board.mk
BOARD_VENDOR_SEPOLICY_DIRS := $(BAK_BOARD_VENDOR_SEPOLICY_DIRS)
BOARD_GLIB_PATCHES_DIRS :=
BOARD_MODEMMANAGER_PATCHES_DIRS :=
